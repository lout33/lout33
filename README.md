...
| Project | What | Links |
|---------|------|-------|
| Claude Life Assistant | Symbiotic AI agent, 632+ stars | Code (https://github.com/lout33/claude_life_assistant) |
| So Long Sucker | AI deception research, 146 games | Demo (https://so-long-sucker.vercel.app) · Code (https://github.com/lout33/so-long-sucker) |
